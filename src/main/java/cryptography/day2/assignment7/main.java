package cryptography.day2.assignment7;
 ...
 */
public class main {
    static String plaintext = "CRIwqt4+szDbqkNY+I0qbDe3LQz0wiw0SuxBQtAM5TDdMbjCMD/venUDW9BL" +
            ...
            "S15AVD2QS1V6fhRimJSVyT6QuGb8tKRsl2N+a2Xze36vgMhw7XK7zh//jC2H"; /*Note null padding*/
    static String encryptionKey = "YELLOW SUBMARINE";
    public static void main(String[] args) throws Exception {
        Cipher cipher = Cipher.getInstance("AES/ECB/NoPadding");
        SecretKeySpec key = new SecretKeySpec(encryptionKey.getBytes("UTF-8"), "AES");
        cipher.init(Cipher.DECRYPT_MODE, key);
        byte[] output = cipher.doFinal(Base64.getDecoder().decode(plaintext.getBytes("UTF-8")));
